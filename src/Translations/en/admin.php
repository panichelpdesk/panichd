...
// tickets-admin/category/____
  ...
  'category-email-default'        => 'Email address',
  'category-email-info'           => 'Sender email used on all notifications in this category. If empty, each notification default email will be used',
