...
return [
    ...
    'admin_route'              => '<p><b>Panic Help Desk административный route</b>: URL по которому будет находиться административная панель (например <code>http://&laquo;APP_URL&raquo;/panichd</code>)</p>',
