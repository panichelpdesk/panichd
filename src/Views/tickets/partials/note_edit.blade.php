<div class="modal fade" id="comment-modal-edit-{{$comment->id}}" tabindex="-1" role="dialog" aria-labelledby="comment-modal-edit-{{$comment->id}}-Label">
    <div class="modal-dialog model-lg" role="document">
        <div class="modal-content">			
			...
			<div class="modal-header">
                ...
                <h4 class="modal-title" id="ticket-comment-modal-Label">Editar comentari</h4>
            </div>
