		...
		<div class="media">
		    ...
		    <div class="media-body check_related_text">
				...
				@if($u->currentLevel() > 1 && isset($template) && $template == "createedit")
					<button type="button" role="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal-attachment-edit" data-original_filename="{{ $attachment->original_filename }}" data-prefix="attachment_{{ $attachment->id }}_" style="margin: 0em 0em 0em 1em;">{{ trans('ticketit::lang.btn-edit') }}</button>
