    ...
    <div class="modal-dialog model-lg" role="document">
        <div class="modal-content">			
			...
			<div class="modal-header">
                ...
                <h4 class="modal-title">{{ trans('ticketit::lang.show-ticket-email-resend') }}</h4>
            </div>
            <div class="modal-body">
				<fieldset>
					<div class="form-group">
						<div class="col-lg-12">
						<label><input type="checkbox" name="to_agent" value="yes"> {{ trans('ticketit::lang.show-ticket-email-resend-agent') . $ticket->agent->name}}</label>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-12">
						<label><input type="checkbox" name="to_owner" value="yes" checked="checked"> {{ trans('ticketit::lang.show-ticket-email-resend-user') }}<span id="owner"></span></label>
						</div>
					</div>
