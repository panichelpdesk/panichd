    ...
    <div class="well bs-component">
        {!! CollectiveForm::open([
			...
			<div class="form-group"><!-- SUBJECT -->
                {!! CollectiveForm::label('subject', '*' . trans('ticketit::lang.subject') . trans('ticketit::lang.colon'), ['class' => 'col-lg-3 control-label']) !!}
                <div class="col-lg-9">
			...
			<div class="form-group"><!-- CATEGORY -->
				{!! CollectiveForm::label('category', '*' . trans('ticketit::lang.category') . trans('ticketit::lang.colon'), ['class' => 'col-lg-3 control-label']) !!}
				<div class="col-lg-9">
