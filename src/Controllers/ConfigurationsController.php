...
class ConfigurationsController extends Controller
{
	...
	*/
	public function index()
	{
		...
		$tickets_section = ['default_status_id', 'default_close_status_id', 'default_reopen_status_id', 'paginate_items', 'attachments_ticket_max_size', 'attachments_ticket_max_files_num', 'attachments_mimes', 'attachments_path', 'thumbnails_path'];
